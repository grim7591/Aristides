...
School_Zones = pd.read_csv('Data/SchoolsCopy.csv')
#result = pd.read_csv('Data/dp2124c.csv')
result.rename(columns={'Name': 'Market_Cluster_ID'}, inplace=True)
School_Zones.replace("<NULL>", pd.NA, inplace=True)
School_Zones['School_Combination'] = School_Zones[['MiddleSchool', 'HighSchool']].agg('_'.join, axis=1)
...
School_Zones['prop_id'] = School_Zones['prop_id'].astype(str)

#%% 
# Merging School_Combination first
result = result.merge(School_Zones[['prop_id', 'HighSchool', 'MiddleSchool', 'ElementarySchool', 'School_Combination']], 
                      on='prop_id', how='left')

# Removing spaces and slashes from all relevant columns
cols_to_clean = ['HighSchool', 'MiddleSchool', 'ElementarySchool', 'School_Combination']
result[cols_to_clean] = result[cols_to_clean].apply(lambda x: x.str.replace(r"[ /]", "", regex=True))
...
regressionFormula = "np.log(Assessment_Val) ~ np.log(living_area) + np.log(landiness) + np.log(percent_good) + np.log(imprv_det_quality_cd) + np.log(total_porch_area + 1) + np.log(total_garage_area + 1) + number_of_baths + in_subdivision + has_lake + has_canal + Alachua_Main + Archer + Buck_Bay + Carol_Estates + Duck_Pond + EastGNV + EastMidtownEastA + Golfview + Haile_Like + Hawthorne + Hickory_Forest + High_Springs_Main + HighSpringsA + HighSpringsAGNV + HighSpringsAGNVSouth + HighSpringsB+HSBUI_2 + Ironwood + Jonesville + Kanapaha + Lincoln_Estates + Lugano + MidtownEast_A + MidtownEast_B + MidtownEast_C + Montery  + Newnans_Lake + QuailCreek + Rural_North + Rural_South + San_Felasco + Sorrento + Split_Rock + Springtree + SummerCreek + Sweetwater + swNewberry_A + swNewberry_B + TC_Forest + Tioga + Tioga_A + Tioga_B + Turkey_Creek + Valwood + Waldo + WaldoRural + Westchester + WildsPlantation + KanapahaMiddle_BuchholzHigh + FortClarkeMiddle_BuchholzHigh + MebaneMiddle_SantaFeHigh + OakViewMiddle_NewberryHigh + KanapahaMiddle_GainesvilleHigh + HighSpringsCommunity_SantaFeHigh + HowardBishopMiddle_EastsideHigh + LincolnMiddle_EastsideHigh + FortClarkeMiddle_GainesvilleHigh + HawthorneMiddleHigh_HawthorneMiddleHigh + WestwoodMiddle_BuchholzHigh + anapahaMiddle_EastsideHigh"
#regressionFormula = "np.log(Assessment_Val) ~ np.log(living_area) + np.log(landiness) + np.log(percent_good) + np.log(imprv_det_quality_cd) + np.log(total_porch_area + 1) + np.log(total_garage_area + 1) + number_of_baths + in_subdivision + has_lake + has_canal + Alachua_Main + Archer + Buck_Bay + Carol_Estates + Duck_Pond + EastGNV + EastMidtownEastA + Golfview + Haile_Like + Hawthorne + Hickory_Forest + High_Springs_Main + HighSpringsA + HighSpringsAGNV + HighSpringsAGNVSouth + HighSpringsB+HSBUI_2 + Ironwood + Jonesville + Kanapaha + Lincoln_Estates + Lugano + MidtownEast_A + MidtownEast_B + MidtownEast_C + Montery  + Newnans_Lake + QuailCreek + Rural_North + Rural_South + San_Felasco + Sorrento + Split_Rock + Springtree + SummerCreek + Sweetwater + swNewberry_A + swNewberry_B + TC_Forest + Tioga + Tioga_A + Tioga_B + Turkey_Creek + Valwood + Waldo + WaldoRural + Westchester + WildsPlantation + GlenSpringsElementary_WestwoodMiddle + TalbotElementary_FortClarkeMiddle + ChesterShellElementary_HawthorneMiddleHigh + StephenFosterElementary_WestwoodMiddle + MetcalfeElementary_HowardBishopMiddle + ArcherElementary_OakViewMiddle + IdylwildElementary_KanapahaMiddle + RawlingsElementary_HowardBishopMiddle + TalbotElementary_WestwoodMiddle + LittlewoodElementary_FortClarkeMiddle + MeadowbrookElementary_KanapahaMiddle + TalbotElementary_MebaneMiddle + LakeForestElementary_LincolnMiddle + WilliamsElementary_LincolnMiddle + TerwilligerElementary_KanapahaMiddle + HiddenOakElementary_KanapahaMiddle + GlenSpringsElementary_FortClarkeMiddle + MetcalfeElementary_WestwoodMiddle + IdylwildElementary_LincolnMiddle + MeadowbrookElementary_OakViewMiddle + RawlingsElementary_WestwoodMiddle + LakeForestElementary_HowardBishopMiddle + NortonElementary_MebaneMiddle + TerwilligerElementary_FortClarkeMiddle + ChilesElementary_FortClarkeMiddle + LakeForestElementary_HawthorneMiddleHigh + CarolynBeatriceParkerElementary_KanapahaMiddle + MeadowbrookElementary_MebaneMiddle"
#regressionFormula = "np.log(Assessment_Val) ~ np.log(living_area) + np.log(landiness) + np.log(percent_good) + np.log(imprv_det_quality_cd) + np.log(total_porch_area + 1) + np.log(total_garage_area + 1) + number_of_baths + in_subdivision + has_lake + has_canal + Alachua_Main + Archer + Buck_Bay + Carol_Estates + Duck_Pond + EastGNV + EastMidtownEastA + Golfview + Haile_Like + Hawthorne + Hickory_Forest + High_Springs_Main + HighSpringsA + HighSpringsAGNV + HighSpringsAGNVSouth + HighSpringsB+HSBUI_2 + Ironwood + Jonesville + Kanapaha + Lincoln_Estates + Lugano + MidtownEast_A + MidtownEast_B + MidtownEast_C + Montery  + Newnans_Lake + QuailCreek + Rural_North + Rural_South + San_Felasco + Sorrento + Split_Rock + Springtree + SummerCreek + Sweetwater + swNewberry_A + swNewberry_B + TC_Forest + Tioga + Tioga_A + Tioga_B + Turkey_Creek + Valwood + Waldo + WaldoRural + Westchester + WildsPlantation + MeadowbrookElementary_BuchholzHigh + NortonElementary_GainesvilleHigh + AlachuaElementary_SantaFeHigh + WilesElementary_BuchholzHigh + CarolynBeatriceParkerElementary_GainesvilleHigh + TalbotElementary_GainesvilleHigh + HiddenOakElementary_BuchholzHigh + HighSpringsCommunity_SantaFeHigh + LittlewoodElementary_BuchholzHigh + NewberryElementary_NewberryHigh + GlenSpringsElementary_GainesvilleHigh + WilesElementary_GainesvilleHigh + ChesterShellElementary_HawthorneMiddleHigh + StephenFosterElementary_GainesvilleHigh + MetcalfeElementary_EastsideHigh + ArcherElementary_NewberryHigh + LakeForestElementary_EastsideHigh + RawlingsElementary_EastsideHigh + IdylwildElementary_GainesvilleHigh + LittlewoodElementary_GainesvilleHigh + TalbotElementary_SantaFeHigh + TerwilligerElementary_BuchholzHigh + WilliamsElementary_EastsideHigh + IdylwildElementary_EastsideHigh + GlenSpringsElementary_BuchholzHigh + MetcalfeElementary_GainesvilleHigh + RawlingsElementary_GainesvilleHigh + MeadowbrookElementary_NewberryHigh + NortonElementary_SantaFeHigh + WilliamsElementary_GainesvilleHigh + LakeForestElementary_HawthorneMiddleHigh + MeadowbrookElementary_SantaFeHigh + IdylwildElementary_BuchholzHigh"
#regressionFormula = "np.log(Assessment_Val) ~ np.log(living_area) + np.log(landiness) + np.log(percent_good) + np.log(imprv_det_quality_cd) + np.log(total_porch_area + 1) + np.log(total_garage_area + 1) + number_of_baths + in_subdivision + has_lake + has_canal + Alachua_Main + Archer + Buck_Bay + Carol_Estates + Duck_Pond + EastGNV + EastMidtownEastA + Golfview + Haile_Like + Hawthorne + Hickory_Forest + High_Springs_Main + HighSpringsA + HighSpringsAGNV + HighSpringsAGNVSouth + HighSpringsB+HSBUI_2 + Ironwood + Jonesville + Kanapaha + Lincoln_Estates + Lugano + MidtownEast_A + MidtownEast_B + MidtownEast_C + Montery  + Newnans_Lake + QuailCreek + Rural_North + Rural_South + San_Felasco + Sorrento + Split_Rock + Springtree + SummerCreek + Sweetwater + swNewberry_A + swNewberry_B + TC_Forest + Tioga + Tioga_A + Tioga_B + Turkey_Creek + Valwood + Waldo + WaldoRural + Westchester + WildsPlantation + KanapahaMiddle + FortClarkeMiddle + MebaneMiddle + OakViewMiddle + HighSpringsCommunity + HowardBishopMiddle + LincolnMiddle + HawthorneMiddleHigh"
#regressionFormula = "np.log(Assessment_Val) ~ np.log(living_area) + np.log(landiness) + np.log(percent_good) + np.log(imprv_det_quality_cd) + np.log(total_porch_area + 1) + np.log(total_garage_area + 1) + number_of_baths + in_subdivision + has_lake + has_canal + Alachua_Main + Archer + Buck_Bay + Carol_Estates + Duck_Pond + EastGNV + EastMidtownEastA + Golfview + Haile_Like + Hawthorne + Hickory_Forest + High_Springs_Main + HighSpringsA + HighSpringsAGNV + HighSpringsAGNVSouth + HighSpringsB+HSBUI_2 + Ironwood + Jonesville + Kanapaha + Lincoln_Estates + Lugano + MidtownEast_A + MidtownEast_B + MidtownEast_C + Montery  + Newnans_Lake + QuailCreek + Rural_North + Rural_South + San_Felasco + Sorrento + Split_Rock + Springtree + SummerCreek + Sweetwater + swNewberry_A + swNewberry_B + TC_Forest + Tioga + Tioga_A + Tioga_B + Turkey_Creek + Valwood + Waldo + WaldoRural + Westchester + WildsPlantation + MeadowbrookElementary + NortonElementary + ChilesElementary + TalbotElementary + AlachuaElementary + LittlewoodElementary + CarolynBeatriceParkerElementary + HiddenOakElementary + HighSpringsCommunity + GlenSpringsElementary + NewberryElementary + MetcalfeElementary + IdylwildElementary + RawlingsElementary + ChesterShellElementary + StephenFosterElementary + LakeForestElementary + ArcherElementary + WilliamsElementary + TerwilligerElementary"
#regressionFormula = "np.log(Assessment_Val) ~ np.log(living_area) + np.log(landiness) + np.log(percent_good) + np.log(imprv_det_quality_cd) + np.log(total_porch_area + 1) + np.log(total_garage_area + 1) + number_of_baths + in_subdivision + has_lake + has_canal + Alachua_Main + Archer + Buck_Bay + Carol_Estates + Duck_Pond + EastGNV + EastMidtownEastA + Golfview + Haile_Like + Hawthorne + Hickory_Forest + High_Springs_Main + HighSpringsA + HighSpringsAGNV + HighSpringsAGNVSouth + HighSpringsB+HSBUI_2 + Ironwood + Jonesville + Kanapaha + Lincoln_Estates + Lugano + MidtownEast_A + MidtownEast_B + MidtownEast_C + Montery  + Newnans_Lake + QuailCreek + Rural_North + Rural_South + San_Felasco + Sorrento + Split_Rock + Springtree + SummerCreek + Sweetwater + swNewberry_A + swNewberry_B + TC_Forest + Tioga + Tioga_A + Tioga_B + Turkey_Creek + Valwood + Waldo + WaldoRural + Westchester + WildsPlantation + BuchholzHigh + SantaFeHigh + EastsideHigh + NewberryHigh + HawthorneMiddleHigh"
#regressionFormula = "np.log(Assessment_Val) ~ np.log(living_area) + np.log(landiness) + np.log(percent_good) + np.log(imprv_det_quality_cd) + np.log(total_porch_area + 1) + np.log(total_garage_area + 1) + number_of_baths + in_subdivision + has_lake + has_canal + Alachua_Main + Archer + Buck_Bay + Carol_Estates + Duck_Pond + EastGNV + EastMidtownEastA + Golfview + Haile_Like + Hawthorne + Hickory_Forest + High_Springs_Main + HighSpringsA + HighSpringsAGNV + HighSpringsAGNVSouth + HighSpringsB+HSBUI_2 + Ironwood + Jonesville + Kanapaha + Lincoln_Estates + Lugano + MidtownEast_A + MidtownEast_B + MidtownEast_C + Montery  + Newnans_Lake + QuailCreek + Rural_North + Rural_South + San_Felasco + Sorrento + Split_Rock + Springtree + SummerCreek + Sweetwater + swNewberry_A + swNewberry_B + TC_Forest + Tioga + Tioga_A + Tioga_B + Turkey_Creek + Valwood + Waldo + WaldoRural + Westchester + WildsPlantation + NortonElementary_WestwoodMiddle_GainesvilleHigh + AlachuaElementary_MebaneMiddle_SantaFeHigh + WilesElementary_KanapahaMiddle_BuchholzHigh + MeadowbrookElementary_FortClarkeMiddle_BuchholzHigh + CarolynBeatriceParkerElementary_WestwoodMiddle_GainesvilleHigh + HighSpringsCommunity_HighSpringsCommunity_SantaFeHigh + NewberryElementary_OakViewMiddle_NewberryHigh + HiddenOakElementary_FortClarkeMiddle_BuchholzHigh + GlenSpringsElementary_WestwoodMiddle_GainesvilleHigh + WilesElementary_KanapahaMiddle_GainesvilleHigh + TalbotElementary_FortClarkeMiddle_GainesvilleHigh + ChesterShellElementary_HawthorneMiddleHigh_HawthorneMiddleHigh + LittlewoodElementary_WestwoodMiddle_BuchholzHigh + ArcherElementary_OakViewMiddle_NewberryHigh + StephenFosterElementary_WestwoodMiddle_GainesvilleHigh + MetcalfeElementary_HowardBishopMiddle_EastsideHigh + TalbotElementary_WestwoodMiddle_GainesvilleHigh + RawlingsElementary_HowardBishopMiddle_EastsideHigh + LittlewoodElementary_WestwoodMiddle_GainesvilleHigh + LittlewoodElementary_FortClarkeMiddle_BuchholzHigh + MeadowbrookElementary_KanapahaMiddle_BuchholzHigh + TalbotElementary_MebaneMiddle_SantaFeHigh + IdylwildElementary_KanapahaMiddle_GainesvilleHigh + LakeForestElementary_LincolnMiddle_EastsideHigh + WilliamsElementary_LincolnMiddle_EastsideHigh + TerwilligerElementary_KanapahaMiddle_BuchholzHigh + HiddenOakElementary_KanapahaMiddle_BuchholzHigh + GlenSpringsElementary_FortClarkeMiddle_BuchholzHigh + MetcalfeElementary_WestwoodMiddle_GainesvilleHigh + IdylwildElementary_LincolnMiddle_EastsideHigh + MeadowbrookElementary_OakViewMiddle_NewberryHigh + RawlingsElementary_WestwoodMiddle_GainesvilleHigh + LakeForestElementary_HowardBishopMiddle_EastsideHigh + NortonElementary_MebaneMiddle_SantaFeHigh + IdylwildElementary_KanapahaMiddle_EastsideHigh + TerwilligerElementary_FortClarkeMiddle_BuchholzHigh + ChilesElementary_FortClarkeMiddle_BuchholzHigh + WilliamsElementary_LincolnMiddle_GainesvilleHigh + IdylwildElementary_LincolnMiddle_GainesvilleHigh + CarolynBeatriceParkerElementary_KanapahaMiddle_GainesvilleHigh + LakeForestElementary_HawthorneMiddleHigh_HawthorneMiddleHigh + RawlingsElementary_HowardBishopMiddle_GainesvilleHigh + MeadowbrookElementary_MebaneMiddle_SantaFeHigh + IdylwildElementary_KanapahaMiddle_BuchholzHigh"
#regressionFormula = "np.log(Assessment_Val) ~ np.log(living_area) + np.log(landiness) + np.log(percent_good) + np.log(imprv_det_quality_cd) + np.log(total_porch_area + 1) + np.log(total_garage_area + 1) + number_of_baths + in_subdivision + has_lake + has_canal + NortonElementary_WestwoodMiddle_GainesvilleHigh + AlachuaElementary_MebaneMiddle_SantaFeHigh + WilesElementary_KanapahaMiddle_BuchholzHigh + MeadowbrookElementary_FortClarkeMiddle_BuchholzHigh + CarolynBeatriceParkerElementary_WestwoodMiddle_GainesvilleHigh + HighSpringsCommunity_HighSpringsCommunity_SantaFeHigh + NewberryElementary_OakViewMiddle_NewberryHigh + HiddenOakElementary_FortClarkeMiddle_BuchholzHigh + GlenSpringsElementary_WestwoodMiddle_GainesvilleHigh + WilesElementary_KanapahaMiddle_GainesvilleHigh + TalbotElementary_FortClarkeMiddle_GainesvilleHigh + ChesterShellElementary_HawthorneMiddleHigh_HawthorneMiddleHigh + LittlewoodElementary_WestwoodMiddle_BuchholzHigh + ArcherElementary_OakViewMiddle_NewberryHigh + StephenFosterElementary_WestwoodMiddle_GainesvilleHigh + MetcalfeElementary_HowardBishopMiddle_EastsideHigh + TalbotElementary_WestwoodMiddle_GainesvilleHigh + RawlingsElementary_HowardBishopMiddle_EastsideHigh + LittlewoodElementary_WestwoodMiddle_GainesvilleHigh + LittlewoodElementary_FortClarkeMiddle_BuchholzHigh + MeadowbrookElementary_KanapahaMiddle_BuchholzHigh + TalbotElementary_MebaneMiddle_SantaFeHigh + IdylwildElementary_KanapahaMiddle_GainesvilleHigh + LakeForestElementary_LincolnMiddle_EastsideHigh + WilliamsElementary_LincolnMiddle_EastsideHigh + TerwilligerElementary_KanapahaMiddle_BuchholzHigh + HiddenOakElementary_KanapahaMiddle_BuchholzHigh + GlenSpringsElementary_FortClarkeMiddle_BuchholzHigh + MetcalfeElementary_WestwoodMiddle_GainesvilleHigh + IdylwildElementary_LincolnMiddle_EastsideHigh + MeadowbrookElementary_OakViewMiddle_NewberryHigh + RawlingsElementary_WestwoodMiddle_GainesvilleHigh + LakeForestElementary_HowardBishopMiddle_EastsideHigh + NortonElementary_MebaneMiddle_SantaFeHigh + IdylwildElementary_KanapahaMiddle_EastsideHigh + TerwilligerElementary_FortClarkeMiddle_BuchholzHigh + ChilesElementary_FortClarkeMiddle_BuchholzHigh + WilliamsElementary_LincolnMiddle_GainesvilleHigh + IdylwildElementary_LincolnMiddle_GainesvilleHigh + CarolynBeatriceParkerElementary_KanapahaMiddle_GainesvilleHigh + LakeForestElementary_HawthorneMiddleHigh_HawthorneMiddleHigh + RawlingsElementary_HowardBishopMiddle_GainesvilleHigh + MeadowbrookElementary_MebaneMiddle_SantaFeHigh + IdylwildElementary_KanapahaMiddle_BuchholzHigh"
# %% [markdown]
# ### Train/Test Split
